...
export const workExperience = [
    {
        ...
        desc: "Led the development of an AI ChatBot for the company's website using Rasa and OpenAI.",
    ...
    },
    {
        ...
        desc: "Designed and programmed timecoded light shows for clubs and events using TigerTouch and Resolume Arena.",
        className: "md:col-span-2",
        thumbnail: "/exp1.svg",
    },
    {
        id: 3,
        title: "SEO Intern",
        desc: "Contributed to the development of SEO strategies to enhance search rankings for clients at WeaveAsia.",
        className: "md:col-span-2",
        thumbnail: "/exp2.svg",
    },
    {
        ...
        desc: "Held residencies at multiple clubs in Kota Kinabalu, specializing in R&B, House, and Big Room genres.",
        className: "md:col-span-2",
        thumbnail: "/exp4.svg",
    },
];
